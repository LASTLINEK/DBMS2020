...
{
	HTREEITEM hRoot = m_wndClassView.InsertItem(_T("数据库1"), 0, 0);
	m_wndClassView.SetItemState(hRoot, TVIS_BOLD, TVIS_BOLD);

	HTREEITEM hClass = m_wndClassView.InsertItem(_T("表1"), 1, 1, hRoot);
	m_wndClassView.InsertItem(_T("列1"), 3, 3, hClass);

	m_wndClassView.Expand(hRoot, TVE_EXPAND);

	hClass = m_wndClassView.InsertItem(_T("表2"), 1, 1, hRoot);
	m_wndClassView.InsertItem(_T("字段1"), 3, 3, hClass);
	m_wndClassView.InsertItem(_T("字段2"), 3, 3, hClass);
	m_wndClassView.InsertItem(_T("字段3"), 3, 3, hClass);

	hClass = m_wndClassView.InsertItem(_T("表3"), 1, 1, hRoot);
	m_wndClassView.InsertItem(_T("字段1"), 4, 4, hClass);
	m_wndClassView.InsertItem(_T("字段2"), 3, 3, hClass);
	m_wndClassView.InsertItem(_T("字段3"), 3, 3, hClass);
