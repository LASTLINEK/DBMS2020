...
BEGIN_MESSAGE_MAP(CRKDBMSApp, CWinAppEx)
...
CRKDBMSApp::CRKDBMSApp() noexcept
{
...
// CRKDBMSApp 自定义加载/保存方法

void CRKDBMSApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CRKDBMSApp::LoadCustomState()
{
}

void CRKDBMSApp::SaveCustomState()
{
}
